...
export const getPasswordResetOTPTemplate = (otp: string, name: string): string => {
  return `
<!DOCTYPE html>
<html>
<head>
...
export const getContactFormEmailTemplate = (contact: {
  name: string;
  email: string;
  mobile?: string;
  city?: string;
...
export const getOrderNotificationTemplate = (order: any, customerName: string): string => {
...
export const getProfileUpdateConfirmationTemplate = (userName: string, changes: string[]): string => {
  return `
<!DOCTYPE html>
<html>
<head>
...
export const getOrderConfirmationTemplate = (order: any, customerName: string): string => {

...
export declare const requestCancellation: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const approveCancellation: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const rejectCancellation: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const getCancellationRequests: (req: Request, res: Response) => Promise<void>;

...
exports.generateInvoice = exports.exportOrders = exports.updateStatus = exports.getById = exports.getAll = exports.create = void 0;
...
const create = async (req, res) => {
    try {
        ...
        const body = req.body;
        const { userId: requestUserId, items, address, subtotal, tax, total, paymentMethod, razorpayOrderId, razorpayPaymentId, razorpaySignature } = body;

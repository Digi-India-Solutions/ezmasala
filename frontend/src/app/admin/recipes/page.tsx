    ...
    <div className="w-full min-h-screen px-4 sm:px-6 py-8 sm:py-12">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 gap-4">
          ...
          <Link href="/admin/recipes/create" className="bg-black text-white px-4 sm:px-6 py-2 rounded-xl font-semibold hover:bg-gray-800 text-center text-sm sm:text-base">
            Add New Recipe
          </Link>
        </div>

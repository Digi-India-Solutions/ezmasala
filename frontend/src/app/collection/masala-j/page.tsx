    ...
    <>
      ...
      <div className="py-4 md:py-8 bg-gray-50 min-h-screen">
        <div className="container mx-auto px-4">
          ...
          {/* HERO SECTION */}
          <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-3xl shadow-xl p-8 md:p-12 mb-10">
          ...
          {/* CTA SECTION */}
          <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-3xl shadow-2xl p-8 md:p-12 mb-10 max-w-5xl mx-auto text-center">
            ...
            <Link href="/collections">
              <button className="bg-white text-orange-600 px-8 py-4 rounded-xl font-bold hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 inline-flex items-center gap-2">
                Shop EZ Masala J
